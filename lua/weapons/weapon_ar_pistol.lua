...
SWEP.Instructions = "这款钢/聚合物AR-15半自动手枪使用5.56x45口径。枪管短于16英寸的步枪法定长度，使用手枪缓冲管或稳定臂代替枪托，提供了比长管型号更紧凑、更强大的替代方案。其紧凑的尺寸使其能在狭小空间中使用，而其多功能性和可定制性在民用市场中开辟了自己的 niche。作为AR平台多功能性的证明，AR-15手枪象征着个人防卫和娱乐射击之间的平衡。\n\nALT+E切换姿态（+行走，+使用）"
