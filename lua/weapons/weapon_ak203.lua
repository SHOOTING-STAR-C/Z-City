...
SWEP.Instructions = "一件非凡的强大力量工具，这款钢制7.62x39mm可选择射击模式的导气式回转闭锁步枪，能够以半自动或全自动模式射击，是20世纪中期苏军军力的缩影。射速约600发/分钟，使用10、20或30发可拆卸盒式弹匣。这款由著名米哈伊尔·卡拉什尼科夫设计的AKM，是苏联技术进步的象征。其坚固的设计和在恶劣条件下的可靠性能，凸显了它作为在全球战争史上留下不可磨灭印记的武器的声誉。"
