...
SWEP.Instructions = "一件极其强大的武器，这款钢/聚合物9x39mm导气式、可选择性射击、整体消音步枪AS VAL，是20世纪80年代中期苏联特种部队的缩影。配备20发弹匣、折叠枪托和手枪握把，专为精准和隐秘而设计。其独特设计可发射亚音速弹药，将枪口火焰和声响降低到仅如耳语。这使得AS VAL在正确的人手中成为一把可怕的武器，象征着专业战争无声而致命的效率。\n\n射速 900发/分钟"
