...
SWEP.Instructions = "AR-15风格步枪是一种轻型半自动步枪，基于或类似于柯尔特AR-15设计。柯尔特型号取消了其前身——由尤金·斯通纳设计的原版阿玛莱特AR-15（本身是AR-10的缩小衍生型）的连发功能。它与军用M16步枪密切相关。AR-15是保卫财产的好步枪。使用5.56x45mm口径"
