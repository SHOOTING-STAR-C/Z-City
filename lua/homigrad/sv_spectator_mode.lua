...
-- Table to track which players are in spectator mode (sole source of truth)
...
-- Hook: Periodically enforce NPC ignorance for spectator players
...
-- Hook: Reset spectator mode on round start
