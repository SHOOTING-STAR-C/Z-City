					...
					if IsValid(phys_head) then
						...
						if bone_lhand then
							...
							if IsValid(phys_lhand) then
								SafeRemoveEntityDelayed(CreateSpring(phys_head, phys_lhand, 25), die_time:GetFloat())
							end
						end
						...
						if bone_rhand then
							...
							if IsValid(phys_rhand) then			
								SafeRemoveEntityDelayed(CreateSpring(phys_head, phys_rhand, 25), die_time:GetFloat())
							end
						end
					end
				end
